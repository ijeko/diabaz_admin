      ...
      <div class="card-header">
        ...
        <div class="d-flex justify-content-center flex-wrap p-1">
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            >
              <a class="nav-link" :class="'alert-'+status.color.replace('list-group-item-', '')" :id="'statusID'+index"
                 data-toggle="tab" :href="'#contentID'+index" role="tab" :aria-controls="'contentID'+index"
                 aria-selected="true">{{ status.status }} ({{filterOrdersByStatus(status.id).length}})</a>
            </li>
            <li class="nav-item" role="presentation">
